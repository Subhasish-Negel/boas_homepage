...
const Banner = () => {
  return (
    <div className="flex flex-col max-h-96 md:flex-row w-full bg-white px-6 xs:px-20 md:px-0 xl:px-36 gap-4">
      ...
      <div className="bg-banner-bg bg-cover bg-bottom h-60 md:h-96 w-full md:w-1/2">
        <div className="w-full h-full bg-white/20 flex justify-center">
          <div className="flex flex-col xs:flex-row items-center justify-center space-y-4 xs:space-y-0 space-x-0 xs:space-x-2 sm:space-x-6 md:space-x-4 lg:space-x-8">
